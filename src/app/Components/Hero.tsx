...
//   </h1>
//   <div>
// <button className="bg-teal-600 text-white py-4 px-6 rounded-md hover:bg-blue-700 transition-all duration-300 flex items-center gap-x-2">
// Shop Now
// <FaArrowRightLong />
// </button>
// </div>
...
// {/* Right Side Image */}
// <div className="w-full md:w-1/2 flex justify-center ml-10 mt-10 md:mt-0 ">
//   <Image 
//     src="/chair-1.png" 
//     alt="chair" 
//     width={434} 
